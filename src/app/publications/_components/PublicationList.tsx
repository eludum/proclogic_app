...
import { BuildingIcon, CalendarIcon, CheckCircleIcon, ChevronLeftIcon, ChevronRightIcon, ClockIcon, CodeIcon, MapPinIcon, PlusIcon, StarIcon, TagIcon, ThumbsUpIcon } from 'lucide-react';
                ...
                {isLoading ? (
                    ...
                    <>
                        ...
                        <div className="text-center text-sm text-gray-500 dark:text-gray-400 mt-2">
                            Pagina {pagination.page} van {pagination.pages} &middot; Totaal {pagination.total} aanbestedingen
                        </div>
                    </>
                )}
