...
const LegendItem = ({
  ...
  return (
    <li
      className={cx(
        // base
        "group inline-flex flex-nowrap items-center gap-1.5 whitespace-nowrap rounded-xs px-2 py-1 transition",
        hasOnValueChange
...
const ScrollButton = ({ icon, onClick, disabled }: ScrollButtonProps) => {
  ...
  return (
    <button
      ...
      className={cx(
        // base
        "group inline-flex size-5 items-center truncate rounded-xs transition",
        disabled
